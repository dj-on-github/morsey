...
/// Sine-wave side-tone generator for macOS. The Linux path streams PCM to
/// `pacat`; on macOS we synthesise the same sine wave in an
/// AVAudioSourceNode render callback (Float32, mono, engine sample rate).
///
