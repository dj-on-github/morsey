...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get aboutIntro =>
      'मोर्स कोड सीखने का एक अभ्यास उपकरण, Dart / Flutter में लिखा गया।';
  ...
  String get aboutUsbBody =>
      'यह प्रोग्राम एक iambic (दोहरे पैडल वाली) मोर्स कुंजी का समर्थन करता है जो USB पर डिवाइस 413d:2107 के रूप में दिखती है। Linux पर कुंजी सीधे उसके /dev/hidraw नोड से पढ़ी जाती है — कोई ड्राइवर नहीं चाहिए, बशर्ते आपका उपयोगकर्ता डिवाइस पढ़ सके (plugdev समूह / udev नियम)। हर पैडल कीबोर्ड मॉडिफ़ायर बिट (बायाँ Ctrl और दायाँ Ctrl) के रूप में रिपोर्ट होता है; सॉफ़्टवेयर इन दबावों को सही समय वाले डिट और डाह में बदलता है।';
